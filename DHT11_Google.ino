...
const char* ssid = "Cardoso";                //replace with our wifi ssid
const char* password = "mjos2312.";         //replace with your wifi password

const char* host = "script.google.com";
const char *GScriptId = "AKfycbyAUypojdR3Gs69xqRUoz9Z7pbQ03uMawedKB9BXFcKC95HzL0-"; // Replace with your own google script id
